...
const Train = () => {
    ...
    const trainData = async () => {
        const response = await personService.train()
        handleModal();
    ...
    return (
        <>
            <div className="flex items-start justify-between">
                <h3 className="text-xl font-medium text-gray-900 dark:text-white">Train</h3>
            ...
            <div className='mt-8 mb-5'>
                <button onClick={trainData} className="space-y-3 w-full text-white focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Train Data</button >
            </div>
